...
class SceneManager:
    ...
    def __init__(self, screen: pygame.Surface) -> None:
        ...
        self._pending_replace: tuple[str, dict] | None = None
    ...
    def push(self, name: str, data: Optional[dict] = None) -> None:
    ...
    def replace(self, name: str, data: Optional[dict] = None) -> None:
        """Replace current scene with a new scene."""
        self._pending_replace = (name, data or {})
